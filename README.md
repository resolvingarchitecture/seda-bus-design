...
| Dependencies                               | `ra-common`                                                                   | `ra-common`, `log`, `parking_lot`, `crossbeam-queue`            | `ra-common`                                                        | `@resolvingarchitecture/ra-common`                                      | `ra-common-cpp`                                             | `ra-common-cs`                                                                  | `ra-common-go`                                                                       |
...
| Back-pressure default                      | `Reject` (configurable: `Block`/`Reject`/`DropNewest`/`DropOldest`, via `Backpressure`) | `Block`                                                         | `Block`                                                            | `Block`                                                                 | `Block`                                                     | `Block`                                                                         | `Block`                                                                              |
